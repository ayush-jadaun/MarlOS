...
3. `pyproject.toml` - Version bump to 1.0.2
...
```bash
pip install git+https://github.com/ayush-jadaun/MarlOS.git
marl --version  # Should show v1.0.2
...
marl version          # Should show 1.0.2
```
...
| `marl install` crashes | Fixed in v1.0.2! Update: `pip install --upgrade` |
...
- **v1.0.2** - PATH fixes + Installation wizard fix (THIS VERSION)
